...
const List = () => {
    ...
    const [controleBombas, setControleBombas] = useState([]);
    ...
    async function sendEmail() {
        try {
            ...
            const response = await api.get(
                `/controle-bombas/sendEmail${params}`
            );
            setError({});
            setLoading(false);
        } catch (error) {
