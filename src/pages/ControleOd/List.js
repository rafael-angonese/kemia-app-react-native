...
const List = () => {
    ...
    const [controleOds, setControleOds] = useState([]);
    ...
    async function sendEmail() {
        try {
            ...
            const response = await api.get(`/controle-ods/sendEmail${params}`);
            setError({});
            setLoading(false);
        } catch (error) {
            setLoading(false);
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <ScrollView>
                ...
                >
                    <DataTable>
                        ...
                        {controleOds.map((item, index) => (
                            <TouchableOpacity
                                key={item.id}
                                onPress={() => {
                                    navigation.navigate('ControleOdShow', {
                                        item: item,
            ...
            <FAB
                ...
                icon="plus"
                onPress={() =>
                    navigation.navigate('ControleOdNew', {
                        refresh: myAsyncEffect.bind(this),
                    })
                }
            />
