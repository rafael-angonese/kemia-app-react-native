...
const List = () => {
    ...
    const [controlePh, setControlePh] = useState([]);
    ...
    async function sendEmail() {
        try {
            ...
            const response = await api.get(`/controle-phs/sendEmail${params}`);
            setError({});
            setLoading(false);
        } catch (error) {
            setLoading(false);
            ...
            <ScrollView>
                ...
                >
                    <DataTable>
                        ...
                        {controlePh.map((item, index) => (
                            <TouchableOpacity
                                key={item.id}
                                onPress={() => {
                                    navigation.navigate('ControlePhShow', {
                                        item: item,
