...
const Show = ({ route }) => {
    ...
    async function excluir() {
        ...
        setLoading(true);
        try {
            const response = await api.delete('/controle-concentracao-cloros/' + item.id);
            setLoading(false);
            refresh();
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.title_view}>Concentração</Text>
            ...
            <View style={styles.container_row}>
                <Button
                    ...
                    mode="contained"
                    onPress={() =>
                        navigation.navigate('ConcentracaoCloroEdit', {
                            item: item,
