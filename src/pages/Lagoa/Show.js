...
const Show = ({ route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text>OD: {item.is_od == true ? 'Ativo' : 'Inativo'}</Text>
            <Text>SS: {item.is_ss == true ? 'Ativo' : 'Inativo'}</Text>
            <Text>Aeração: {item.is_aeracao == true ? 'Ativo' : 'Inativo'}</Text>
            <Text>Observações: {item.is_observacao == true ? 'Ativo' : 'Inativo'}</Text>
